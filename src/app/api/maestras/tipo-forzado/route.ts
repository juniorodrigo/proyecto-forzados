...
export async function GET() {
	try {
		...
		const { recordset } = await pool.request().query("SELECT * FROM TIPO_FORZADO");
...
export async function POST(request: Request) {
	try {
		...
		const result = await pool.request().input("descripcion", descripcion).query("INSERT INTO TIPO_FORZADO ( DESCRIPCION) VALUES ( @descripcion)");
...
export async function DELETE(request: Request) {
	try {
		...
		const result = await pool.request().input("id", id).query("DELETE FROM TIPO_FORZADO WHERE TIPOFORZADO_ID = @id");
...
export async function PUT(request: Request) {
	try {
		...
		const result = await pool.request().input("id", id).input("descripcion", descripcion).query("UPDATE TIPO_FORZADO SET DESCRIPCION = @descripcion WHERE TIPOFORZADO_ID = @id");
