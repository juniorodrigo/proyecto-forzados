                  ...
                  filteredRows.map((row) => (
                    <tr key={row.id} className="hover:bg-gray-50">
                        ...
                        >
                          ...
                          >
                            {column.key === "estado" ? (
                              ...
                              <span className={row.tipo === "alta" ? "text-red-500" : "text-green-500"}>
                                {row.tipo === "alta" ? <FaArrowUp /> : <FaArrowDown />}
                              </span>
                            ) : (
                              row[column.key]
                            )}
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        {row.estado.startsWith("PENDIENTE") &&
                          user &&
                          (usuariosAprobadores.includes(user.role) || usuariosAdministradores.includes(user.role)) && (
                            <button
                        ...
                        {row.estado !== "FINALIZADO" &&
                          (usuariosSolicitantes.includes(user?.role || -1) ||
                            usuariosAdministradores.includes(user?.role || -1)) &&
